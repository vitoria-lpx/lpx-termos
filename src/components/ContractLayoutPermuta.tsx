    ...
    <div className="bg-white border border-[#16171C]/10 rounded-2xl overflow-hidden shadow-sm">
      <div className="bg-[#EF27FF]/5 border-b border-[#EF27FF]/12 px-8 py-6">
        <p className="text-[10px] font-bold text-[#EF27FF] tracking-[0.2em] uppercase mb-2">
          Termo de Parceria Comercial · Modelo Permuta
        </p>
      ...
      <div className="px-8 py-8 space-y-8 text-sm">
        ...
        <Section title="3. Permuta">
          <Arrow>
            A participação da INFLUENCIADORA na campanha ocorrerá mediante permuta, consistente
            no envio, pela MARCA, diretamente à INFLUENCIADORA, dos produtos previamente
            definidos para a respectiva campanha, sem qualquer pagamento ou contraprestação
            financeira.
          </Arrow>
          <Arrow>
            A INTERMEDIADORA será responsável pelo alinhamento prévio com a INFLUENCIADORA
            quanto aos conteúdos, devendo a INFLUENCIADORA observar integralmente as condições
...
export default function ContractLayoutPermuta() {
  ...
  return (
    <div className="lg:grid lg:grid-cols-[1fr_440px] lg:gap-10 lg:items-start">
      ...
      <div className="mt-6 lg:mt-0 lg:sticky lg:top-8">
        <TermForm apiPath="/api/sign-permuta" />
      </div>
