...
import ContractLayoutCacheFixo from "@/components/ContractLayoutCacheFixo";

export default function CacheFixo() {
  return (
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-10">
        <div className="space-y-2">
          <p className="text-[10px] text-[#EF27FF] tracking-[0.25em] uppercase font-medium">
            Documento Oficial · Modelo Cachê Fixo
          </p>
