...
function buildPDF(params: PDFParams) {
  ...
  y = txt(doc, "O(A) LICENCIANTE fará jus a comissão de 10% (dez por cento) sobre o faturamento mensal gerado por meio de suas indicações ou conteúdos vinculados à LICENCIADA, observadas as seguintes condições:", margin, y, maxW, lh, pageH, margin);
